...
export async function POST() {
  try {
    ...
    // Find the main one (bertporcayo@icloud.com)
    const mainLabel = siestaLabels?.find(l => l.email === 'bertporcayo@icloud.com');
    const otherLabels = siestaLabels?.filter(l => l.id !== mainLabel?.id) || [];
