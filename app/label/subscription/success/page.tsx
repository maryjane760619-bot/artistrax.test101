    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#1F4E3D] to-black flex items-center justify-center p-4">
        <div className="bg-white rounded-lg p-8 max-w-md text-center">
          ...
          <Button onClick={() => router.push('/label/dashboard')}>
            Go to Dashboard
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1F4E3D] to-black flex items-center justify-center p-4">
      <div className="bg-white rounded-lg p-8 max-w-md text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your label subscription has been activated and your <strong>30-day free trial</strong> has started.
        </p>

        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6 text-sm text-left">
          <h3 className="font-semibold mb-2">What's next?</h3>
          <ul className="space-y-2 text-gray-700">
            <li>✓ Upload your catalog</li>
            <li>✓ Manage your artists</li>
            <li>✓ Customize your label profile</li>
            <li>✓ Track label analytics</li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <Button 
            onClick={() => router.push('/label/upload')}
